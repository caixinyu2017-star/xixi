...
BLOCKS = [
    ...
    ("p",
     ...
     f"{n('ratio_ru', 2)} times as strongly as unrelated variety, and "
     "Figure 2b shows the two schedules over the range of bits each component "
     "actually occupies. H3 is supported, with an important qualification. "
