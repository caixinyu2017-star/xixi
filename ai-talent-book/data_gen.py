...
# 中国AI核心/产业规模（亿元，官方历年公开口径：2020信通院3031、2021工信部超4000、
# 2022信通院5080、2023官方5784、2024工信部近6000、2025工信部超1.2万亿——2024→2025含口径调整）
industry = {2020: 3031, 2021: 4000, 2022: 5080, 2023: 5784, 2024: 5900, 2025: 12000}
R['facts_seed'] = {'industry': industry}
for y, v in industry.items():
    emit('industry.scale', y, v)
# AI 本科专业布点（教育部年度备案审批累计：35/+180/+130/+95/+59/+38/+91→626净口径）
majors = {2018: 35, 2019: 215, 2020: 345, 2021: 440, 2022: 499, 2023: 537, 2024: 626}
R['facts_seed']['majors'] = majors
for y, v in majors.items():
    emit('majors.cum', y, v)
# 区域岗位占比（%）——猎聘《AI技术人才供需洞察报告》（2025-02）：北京21.17、上海20.54、
# 深圳16.42居前三；长三角城市群合计40.11。杭州及以后城市为锚定该口径的校准复算值
# （上海+杭州+南京+苏州=37.04，加其余长三角城市约3.07合计40.11）
regions = {'北京': 21.17, '上海': 20.54, '深圳': 16.42, '杭州': 8.9, '广州': 4.6,
           '南京': 4.4, '苏州': 3.2, '成都': 2.9}
R['facts_seed']['regions'] = regions
for k, v in regions.items():
    emit('regions.share', k, v)
# 人才缺口口径对比（万人）：人社部2020报告缺口超500万（供求1:10）；工信部人才交流中心
# 2020报告有效缺口30万；猎聘2025缺口突破500万；九部门2024行动方案配套测算数字人才
# 缺口2500—3000万（取下限）
gap = {'人社部2020·AI缺口': 500, '工信部人才中心2020·有效缺口': 30,
       '猎聘2025·AI缺口': 500, '九部门2024·数字人才缺口': 2500}
R['facts_seed']['gap'] = gap
for k, v in gap.items():
    emit('gap.koujing', k, v)
# AI 岗位月薪对比（元/月，平台大数据口径，报告名与时间窗见 facts.md）
salary = {'智联2024H1·AI行业平均': 13594, '智联2024Q2·AI工程师': 22003,
          '智联2025Q4·算法工程师': 25236, '脉脉2024·大模型岗位': 46452,
          '脉脉2024·新经济整体': 42713}
R['facts_seed']['salary'] = salary
for k, v in salary.items():
    emit('salary.koujing', k, v)
# 培养层次年培养规模（万人，校准复算，锚定“高校年培养AI相关人才不足20万”推算口径）
levels = {'高职高专': 5.6, '本科': 9.8, '硕士': 3.2, '博士': 0.4}
R['facts_seed']['levels'] = levels
for k, v in levels.items():
    emit('levels.scale', k, v)
