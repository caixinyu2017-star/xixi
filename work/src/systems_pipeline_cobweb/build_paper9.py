...
from p9_equations import EQS as EQUATIONS
from p9_content_a import PART_A, TITLE, ABSTRACT, KEYWORDS
from p9_content_b import PART_B
from p9_refs import REFS9 as REFS

SCRATCH = os.path.dirname(os.path.abspath(__file__))
BLOCKS = PART_A + PART_B
FIGS = [f'p9_fig{i}.png' for i in range(1, 8)]
...
body_xml = ''.join(parts)
OUT_NAME = 'Pipeline_Overshoots_Shock_Systems.docx'
