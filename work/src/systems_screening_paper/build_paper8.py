# -*- coding: utf-8 -*-
"""Assemble the paper-7 manuscript docx (employer screening under signal collapse;
choice and architecture experiments)."""
import os, re, sys
...
from p8_equations import EQUATIONS_P8
from p8_content_a import PART_A, TITLE, ABSTRACT, KEYWORDS
from p8_content_b import PART_B
from p8_refs import REFS8 as REFS

SCRATCH = os.path.dirname(os.path.abspath(__file__))
BLOCKS = PART_A + PART_B
FIGS = [f'p8_fig{i}.png' for i in range(1, 8)]
...
for b in BLOCKS:
    ...
    if kind == 'h1':
        ...
        parts.append(p_equation(EQUATIONS_P8[b[1]], b[2]))
    elif kind == 'tabcap':
...
body_xml = ''.join(parts)
OUT_NAME = 'Screening_Under_Signal_Collapse_Systems.docx'
