...
OUT = os.path.join(ROOT, "Too_Much_of_a_Good_Thing_Systems_manuscript.docx")
...
def _typo(s):
    """Typographic minus before numerals and an en dash in year spans."""
    return MINUS.sub("\u2212", YEARSPAN.sub(lambda m: m.group(0).replace("-", "\u2013"), s))
...
def front_matter(doc):
    ...
    for line, sid in (("Academic Editor: Ali Ahsan", "MDPI_1.5_academic_editor"),
