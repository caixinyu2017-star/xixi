...
ABSTRACT = (
    ...
    "transition as a six-state feedback system in which searching, exam-oriented "
    "queueing, matched and mismatched employment, employability capital and "
    "aspirations co-evolve with an employer skill threshold that rises with "
    "digitalisation. Five structural parameters are estimated by simulated method of "
    "moments against seven published moments for China and Zhejiang Province, and all "
    "seven are reproduced within 3.5 per cent. Continuation and a multi-start search "
    "find a unique stable fixed point throughout, so the system has no tipping point. "
    "Instead its attractor drifts: the equilibrium non-employment rate rises from "
    "0.119 to 0.478 between 2015 and 2040 while the realised state lags it by about "
    "two years, so measured indicators understate structural deterioration. A "
    "three-year demand shock decays with a half-life of 1.67 years, whereas the "
    "threshold drift does not decay. A Sobol decomposition attributes 35.8 per cent "
    "of output variance to threshold sensitivity and 0.1 per cent to training "
    "intensity. At equal standardised effort, moderating threshold escalation lowers "
    "the 2040 rate by 0.107, roughly eighteen times the effect of vacancy creation, "
    "and deployment sequencing matters at unchanged cumulative effort."
)
...
KEYWORDS = ("youth employment; school-to-work transition; system dynamics; feedback loop "
            ...
            "sensitivity analysis; policy sequencing; Zhejiang")
...
PART_A = [
    ...
    ('p', 'Between 2015 and 2026 the number of graduates entering China’s labour market '
          ...
          'it did not occur in a slack labour market. Zhejiang Province, the setting of '
          'this study, recorded 5.5 per cent output growth in 2025, and the value added '
          'of its digital core industries reached CNY 1.23 trillion, or 13.0 per cent of '
          'provincial gross regional product {{zjstats2026}}. Vacancy-to-seeker ratios in '
          'the public employment service have stayed above unity throughout. Jobs are '
          'being created; entry into them has nonetheless become slower and less '
          'certain.'),
    ...
    ('p', 'This paper builds and analyses such a system. We formulate a six-state '
          'continuous-time model of the graduate school-to-work transition in Zhejiang '
          'Province, calibrate five structural parameters by simulated method of moments '
          ...
          'experiments including deployment sequencing.'),
    ...
    ('p', 'Four findings follow, and three of them are negative results that we consider '
          ...
          'from a non-employment rate of 0.119 in 2015 to 0.478 in 2040, and because the '
          'slowest relaxation time of the system is exactly eight years, the observed '
          'state lags this moving target by about two years. Measured youth '
          ...
          'digitalisation raises non-employment by at most 0.137 and decays with a '
          'half-life of 1.67 years. The youth employment problem in a frontrunner region '
          'is not a business-cycle problem. Fourth, the instrument that matters is not '
          'the one that is usually deployed. At equal standardised effort, moderating '
          'the rate at which employers raise the hiring bar reduces the 2040 '
          'non-employment rate by 0.107, against 0.006 for vacancy creation and 0.004 '
          'for training intensity.'),

    ('p', 'The contribution is threefold. Theoretically, we show that the youth '
          'employment predicament of a digital frontrunner region is better described as '
          ...
          'analysis showing that the most digitally advanced prefectures face the '
          'steepest deterioration and the largest policy dividend.'),
    ...
    ('p', 'The quantity account holds that graduate supply has outrun graduate-suitable '
          ...
          'unemployment {{tleppayev2025}}. Yet in Zhejiang the vacancy-to-seeker ratio '
          'has remained above unity, and provincial digital-industry expansion has been '
          'rapid and job-creating {{zhoupolicy2024|liu2024sus|broadband}}. A pure quantity account '
          'predicts falling market tightness alongside rising non-employment; the data '
          'show the two moving in opposite directions.'),
    ...
    ('p', 'The model represents the population of degree-holding labour-market entrants '
          'in Zhejiang Province during an eight-year youth window, indexed in units of '
          ...
          'Wages appear only through a composite job-quality index, and geography enters '
          'only through the archetype analysis of Section 4.9. The horizon is 2015 to '
          '2040 with 2025 as the policy-intervention date.'),
    ...
    ('table', [
        ...
        ['⟪\\Psi⟫', 'Digital core industries, share of GRP', 'Share', 'Exogenous driver'],
    ...
    ('notes', 'The pool is ⟪S⟫ + ⟪Q⟫ + ⟪M⟫ + ⟪U⟫. GRP denotes gross regional product. '
    ...
    ('p', 'Digital transformation follows a logistic path anchored on the observed share '
          'of digital core industries in provincial gross regional product '
          '{{zjstats2026}}:'),
    ('eq', 'eq1', 1),
    ...
    ('p', 'The model is a policy-analysis model, not a forecasting model, and we are '
          ...
          'held fixed. Five are estimated. The remainder are structural constants of the '
    ...
    ('table', [
        ...
        ['⟪\\Phi_{0}⟫', 'Entering cohort, 2015', '30.0', '—', 'Set (10⁴ persons)'],
        ...
        ['⟪V_{0}⟫', 'Vacancies, 2015', '38.0', '—', 'Scale normalisation'],
        ...
        ['⟪\\Psi_{0}⟫, ⟪\\Psi_{max}⟫, ⟪r_{\\Psi}⟫',
         'Digital-intensity logistic', '0.090, 0.200, 0.080', '—', 'Fitted to {{zjstats2026}}'],
        ['⟪\\theta_{0}⟫', 'Baseline skill threshold', '0.500', '—', 'Normalisation'],
        ['⟪\\kappa⟫', 'Threshold sensitivity to digitalisation', '2.20', '1.30–3.30', 'Uncertain'],
        ['⟪\\kappa_{2}⟫', 'Endogenous threshold escalation', '0.150', '0.05–0.30', 'Uncertain'],
        ['⟪\\mu⟫', 'Matching efficiency', '9.657', '7.60–11.8', 'Estimated'],
        ['⟪\\alpha⟫', 'Matching elasticity', '0.500', '—', 'Set {{petrongolo2001}}'],
        ['⟪\\beta_{s}⟫', 'Screening sharpness', '6.00', '—', 'Set'],
        ['⟪\\sigma_{0}⟫', 'Match-quality intercept', '0.647', '—', 'Estimated'],
        ...
        ['⟪\\Pi⟫', 'Perceived value of an institutional post', '1.332', '0.90–1.90',
         'Estimated'],
        ['⟪\\varepsilon⟫', 'Probability-weighting curvature', '0.391', '0.320–0.640',
         'Estimated {{prelec1998}}'],
        ['⟪\\beta_{c}⟫', 'Choice sharpness (search versus queue)', '40.0', '—', 'Set'],
        ['⟪\\nu⟫', 'Maximal queue-entry rate', '0.932', '—', 'Estimated'],
    ...
    ('notes', 'Ranges are the supports of the independent uniform priors used in the '
              ...
              'method of moments (Table 3). The higher separation rate for mismatched '
              'employment reflects the elevated quit intentions documented among '
              'over-educated Chinese graduates {{pan2025|mismatch1}}.'),

    ('p', 'Five parameters—matching efficiency, the perceived value of an institutional '
          'post, the probability-weighting curvature, the maximal queue-entry rate and '
          'the match-quality intercept—are estimated by simulated method of moments. The '
          ...
          'polishing. With seven moments and five free parameters the system is '
    ...
    ('table', [
        ...
        ['Youth non-employment rate', '2015', '0.115', '0.119', '+3.50%',
         'Surveyed unemployment, aged 16–24 {{nbs2026}}'],
        ['Slow-employment share of entrants', '2015', '0.060', '0.060', '−0.27%',
         'Graduate destination surveys'],
        ['Vertical mismatch share', '2015', '0.180', '0.183', '+1.89%',
         'Over-education literature {{zheng2021}}'],
        ['Youth non-employment rate', '2025', '0.180', '0.175', '−2.55%',
         'Aged 16–24 excluding students {{nbs2026}}'],
        ['Slow-employment share of entrants', '2025', '0.191', '0.191', '+0.11%',
         'Graduate destination survey, 2024'],
        ['Vertical mismatch share', '2025', '0.240', '0.236', '−1.72%',
         'Over-education literature {{mismatch1|pan2025}}'],
        ['Queue-to-seat ratio', '2026 cycle', '96.0', '96.6', '+0.65%',
         'National civil-service examination'],
    ], [3050, 1150, 1200, 1200, 1400, 1640]),
    ('notes', 'Weighted objective value 0.00301. Root-mean-square percentage error across '
              'the seven moments is 1.80 per cent and the mean signed error is −0.14 per '
              'cent, so the fit is close and essentially unbiased. Chinese national '
              'series are used as proxies where provincial series of matching definition '
              'are not published; Section 5.7 discusses the consequences.'),

    ('p', 'Two limits of this calibration should be stated plainly. First, several targets '
          'are national rather than provincial, because Zhejiang does not publish a '
          'youth unemployment series on the international definition; the model is '
          'therefore best read as representing a Zhejiang-like digital-frontrunner '
          'economy rather than the province in every particular. Second, the model '
          'aggregates all forms of delayed entry into a single queue, whereas the '
          'civil-service examination is only one of them. Consistent with this, the '
          'model reproduces the 2026 congestion ratio closely but under-predicts the 2015 '
          'ratio (35 against 63), that is, it attributes more of the growth in delayed '
          'entry to the recent period than the examination series alone implies. Neither '
          'limitation affects the qualitative results, all of which are shown in '
          'Section 4.6 to be robust across the full parameter uncertainty range.'),
    ...
    ('table', [
        ...
        ['Behaviour reproduction (in sample)', 'Behaviour pattern',
         'Six estimation moments',
         'All within 3.5 per cent'],
        ['Behaviour reproduction (out of sample)', 'Behaviour pattern',
         'Digital-industry share 2025, vacancy-to-seeker ratio 2015, exam ratio 2015',
         '−0.7 per cent, −0.3 per cent, and under-prediction as discussed'],
        ['Sign of the skill-gap reversal', 'Behaviour pattern',
         'Year in which the skill–threshold gap changes sign',
         '2022, consistent with the post-2022 acceleration of youth non-employment'],
    ], [2450, 1750, 3050, 2390]),
    ...
    ('p', 'Third, two-directional continuation in the two candidate control parameters '
          ...
          'separated initial guesses over a 6 × 4 grid of the two strongest reinforcing '
          'parameters tests for multiple equilibria. Fourth, loop dominance is assessed '
