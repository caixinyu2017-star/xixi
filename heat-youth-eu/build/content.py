...
ABSTRACT = (
    ...
    "youth disengagement and that this effect is significantly "
    "attenuated by the green infrastructure endowment, ceasing to be "
    "statistically distinguishable from zero in countries whose "
    "functional urban areas are more than roughly one-third green. "
    "Economic growth and tertiary attainment reduce the NEET rate, "
    "whereas the heat effects are not detectable for the youth "
    "unemployment rate, suggesting that heat stress operates on the "
    "engagement margin of youth labour markets. The findings support "
    "integrated policies that treat urban greening as social "
    "infrastructure for the young generation.")
...
BLOCKS = [
    ...
    ("p",
     ...
     "work [[oke1982],[santamouris2020]], and the summers of 2022, "
     "2023 and 2024 were the hottest in the European observational "
     "record [[esotc2023],[lancetcountdown2024]]. A substantial body "
    ...
    ("p",
     "The purpose of the article is to analyze the relationship "
    ...
    ("p",
     ...
     "country-specific heterogeneity [[rus2026]]. These limitations "
    ...
    ("p",
     ...
     "from period means, which is equivalent to including a full set "
     "of time dummies. Based on the theoretical framework and "
    ...
    ("p",
     ...
     "difference instruments the levels equation, and the exogenous "
     "regressors instrument themselves in differences, resulting in "
    ...
    ("p",
     ...
     f"almost zero in the Nordic countries to more than "
     f"{f1(DE['CDD']['max'] - 100)} in Cyprus, reflecting the "
    ...
    ("p",
     ...
     "green. Importantly, none of the pairwise correlations among "
     "the explanatory variables exceeds the commonly accepted "
     "threshold of 0.80, suggesting the absence of severe "
     "multicollinearity problems. Nevertheless, correlation "
    ...
    ("p",
     ...
     f"{pv(B['p']['CDD100'])}): in a country with no urban green "
     "endowment, an additional hundred degree days of summer heat "
     f"would raise youth disengagement by about "
     f"{f2(B['coef']['CDD100'])} percentage points. The interaction "
     "between heat stress and the green infrastructure endowment is "
     f"negative and statistically significant (β = "
     f"{f4(B['coef']['CDD100 × GRN'])}, "
     f"{pv(B['p']['CDD100 × GRN'])}), supporting Hypothesis H2: "
     ...
     "points. Economic growth reduces youth disengagement "
     f"significantly (β = {f3(B['coef']['GDPG'])}, "
     f"{pv(B['p']['GDPG'])}), supporting Hypothesis H3, and "
     f"tertiary attainment also enters negatively (β = "
     f"{f3(B['coef']['TERT'])}, {pv(B['p']['TERT'])}), supporting "
     "Hypothesis H4, although its contemporaneous contribution is "
     "modest, consistent with the slow-moving nature of educational "
     "expansion."),
    ("p",
     ...
     "green endowment. At the endowment of the least green urban "
     f"systems in the sample (15%), the effect is "
     f"{f2(ME['15']['me'])} percentage points of youth "
     ...
     "mirrored, at the macro level, in a labour-market buffering "
     "capacity: summer heat leaves measurable marks on youth "
     "engagement only where the urban fabric lacks the green "
    ...
    ("p",
     ...
     f"magnitude ({f4(PR['coef']['CDD100 × GRN'])}, "
     f"{pv(PR['p']['CDD100 × GRN'])}), although on the shorter "
     "panel it is estimated less precisely and is significant only "
     "at the 10% level. The diagnostic tests remain satisfactory in "
    ...
    ("p",
     ...
     "economically meaningful: in sparsely green urban systems, a "
     "summer comparable to the European records of 2022–2024, "
     "which added roughly one hundred degree days to the "
     "climatological average in the exposed South, is associated "
     f"with an increase of around {f2(ME['20']['me'])} percentage "
     "points in youth disengagement at an endowment of 20%. Given "
     "the persistence of the NEET rate, such recurring shocks "
     "accumulate: the long-run effect of a permanent increase in "
     "heat exposure is approximately "
     f"{f2(ME['20']['me'] / (1 - B['coef']['L.NEET']))} percentage "
     "points per hundred degree days at that endowment. This "
    ...
    ("h2", "5.2. Green Infrastructure as Thermal and Social "
           "Infrastructure"),
    ("p",
     "The negative and statistically significant interaction between "
     "heat stress and the green infrastructure endowment constitutes "
     "the central contribution of the study to the Special Issue's "
     "theme. The urban climatology literature has established that "
     ...
     "[[iungman2023]]. The present findings indicate that these "
     "thermal benefits extend to a socioeconomic protection: the "
     "same meteorological summer translates into substantially less "
     "youth disengagement in countries whose functional urban areas "
     "are green than in those that are densely sealed. The marginal "
     "heat effect declines from "
    ...
    ("p",
     ...
     "attainment also reduces disengagement, although its "
     "contemporaneous coefficient is modest. One possible "
    ...
    ("p",
     ...
     "NEET rate, and that this effect is significantly attenuated "
     "by the green infrastructure endowment: the marginal effect of "
     "an additional hundred cooling degree days declines from "
     f"{f2(ME['15']['me'])} percentage points in the least green "
     "urban systems to statistical insignificance beyond an "
     f"endowment of roughly {f1(S['me_cutoff'])}% and to "
     "essentially zero in the greenest ones. Economic growth and "
     "tertiary educational attainment reduce youth disengagement, "
     "confirming the cyclical and human-capital determinants "
     "documented in the youth literature. The heat effects are not "
     ...
     "exclusion of the pandemic period. All four research "
     "hypotheses are therefore supported by the empirical "
     "evidence, with the qualification that the attainment effect "
     "is modest and the interaction is estimated less precisely on "
     "the pre-pandemic subsample."),
    ("p",
    ...
    ("p",
     ...
     "effects of greening dynamics over time. Third, cooling degree "
