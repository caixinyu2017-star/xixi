# -*- coding: utf-8 -*-
"""Assemble the job-rationing manuscript as an MDPI Systems .docx."""
import os
import re
import shutil
import sys
...
from rq_equations import EQUATIONS
from rq_content_a import PART_A, TITLE, ABSTRACT, KEYWORDS
from rq_content_b import PART_B
from rq_refs import REFS
...
# ---------------------------------------------------------- body
FIG_FILES = ['fig1_structure.png', 'fig2_mechanism.png',
             'fig3_reform_path.png', 'fig4_channels.png',
             'fig5_indicator.png', 'fig6_policy.png', 'fig7_robustness.png']
FIG_RIDS = {f: f'rId{20 + i}' for i, f in enumerate(FIG_FILES)}
FIG_WIDTH = {'fig1_structure.png': 6.3, 'fig2_mechanism.png': 6.3,
             'fig3_reform_path.png': 6.3, 'fig4_channels.png': 5.4,
             'fig5_indicator.png': 6.2, 'fig6_policy.png': 6.4,
             'fig7_robustness.png': 6.4}
EMU_PER_IN = 914400
...
body_xml = ''.join(parts)
OUT_NAME = 'The_Queue_Absorbs_the_Shock_Job_Rationing_Systems.docx'
